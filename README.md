...
**Current version: 0.13.24**

## Install (friends)

1. Download **`LocalMusicHub-Setup-0.13.24.exe`** from [GitHub Releases](https://github.com/Litbolt123/Local-Music-Hub/releases) (once published).
